...
class Ui_grm_lsi(object):
    def setupUi(self, grm_lsi):
        ...
        self.label = QtWidgets.QLabel(parent=grm_lsi)
        ...
        self.label_2 = QtWidgets.QLabel(parent=grm_lsi)
        self.label_2.setWordWrap(True)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.scrollArea = QtWidgets.QScrollArea(parent=grm_lsi)
        ...
        self.elevation = QtWidgets.QComboBox(parent=self.groupBox)
        ...
        self.swc_dist = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.iter_thin = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.swc_skip = QtWidgets.QSpinBox(parent=self.groupBox_2)
        ...
        self.generalize_method = QtWidgets.QComboBox(parent=self.groupBox_2)
        ...
        self.swc_search = QtWidgets.QSpinBox(parent=self.groupBox_2)
        ...
        self.swc_area_lesser = QtWidgets.QLineEdit(parent=self.groupBox_2)
        self.swc_area_lesser.setObjectName("swc_area_lesser")
        self.gridLayout_8.addWidget(self.swc_area_lesser, 5, 1, 1, 1)
        self.swc_flat = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.generalize_threshold = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.vclean_rmdangle_threshold = QtWidgets.QLineEdit(parent=self.groupBox_2)
        ...
        self.sw_search = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.sw_flat = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.sw_skip = QtWidgets.QSpinBox(parent=self.groupBox_3)
        ...
        self.sw_area_lesser = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.sw_dist = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.vclean_rmarea_threshold = QtWidgets.QLineEdit(parent=self.groupBox_3)
        ...
        self.point_dmax = QtWidgets.QLineEdit(parent=self.groupBox_4)
        ...
        self.label_29 = QtWidgets.QLabel(parent=self.groupBox_4)
        self.label_29.setObjectName("label_29")
        self.gridLayout_9.addWidget(self.label_29, 1, 0, 1, 1)
        self.transect_split_length = QtWidgets.QLineEdit(parent=self.groupBox_4)
        ...
        self.buffer_distance = QtWidgets.QLineEdit(parent=self.groupBox_4)
        ...
        self.transect_side_distances = QtWidgets.QLineEdit(parent=self.groupBox_4)
        ...
        self.run = QtWidgets.QPushButton(parent=grm_lsi)
        ...
        self.reload_layers = QtWidgets.QToolButton(parent=grm_lsi)
        ...
        self.exit = QtWidgets.QPushButton(parent=grm_lsi)
        self.exit.setObjectName("exit")
        self.horizontalLayout_2.addWidget(self.exit)
        self.verticalLayout.addLayout(self.horizontalLayout_2)
        self.add_output = QtWidgets.QCheckBox(parent=grm_lsi)
