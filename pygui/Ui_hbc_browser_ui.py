...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/epi.gif"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/tools.png"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        self.toolWidget.setWindowIcon(icon1)
        self.toolWidget.setLayoutDirection(QtCore.Qt.LayoutDirection(0))
        self.toolWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature(6))
        ...
        self.tools.setTabPosition(QtWidgets.QTabWidget.TabPosition(0))
        self.tools.setTabShape(QtWidgets.QTabWidget.TabShape(0))
        ...
        self.imageBrowsing.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature(6))
        ...
        self.rwd.setFocusPolicy(QtCore.Qt.FocusPolicy(0))
        self.rwd.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/backward.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        self.fwd.setFocusPolicy(QtCore.Qt.FocusPolicy(0))
        self.fwd.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/forward.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        self.zoomto.setFocusPolicy(QtCore.Qt.FocusPolicy(0))
        self.zoomto.setText("")
        ...
        self.range.setStepType(QtWidgets.QAbstractSpinBox.StepType(1))
        ...
        self.ImageIndexSlider.setFocusPolicy(QtCore.Qt.FocusPolicy(0))
        self.ImageIndexSlider.setProperty("value", 0)
        self.ImageIndexSlider.setSliderPosition(0)
        self.ImageIndexSlider.setOrientation(QtCore.Qt.Orientation(1))
        self.ImageIndexSlider.setTickPosition(QtWidgets.QSlider.TickPosition(2))
        ...
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy(4), QtWidgets.QSizePolicy.Policy(4))
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.gisTools.sizePolicy().hasHeightForWidth())
        self.gisTools.setSizePolicy(sizePolicy)
        self.gisTools.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature(6))
        ...
        self.gisToolSplitter.setOrientation(QtCore.Qt.Orientation(1))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/screwdriver-wrench.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/SquadraCompasso_solid.png"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        self.actionTools.setIcon(icon5)
        self.actionTools.setObjectName("actionTools")
        self.actionQuit = QtGui.QAction(parent=MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/power-off.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/pen-to-square.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/map-location-dot.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/image.svg"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/grass_bold_dark.png"), QtGui.QIcon.Mode(0), QtGui.QIcon.State(1))
