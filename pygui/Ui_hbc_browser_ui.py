...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionTools.setIcon(icon4)
        self.actionTools.setObjectName("actionTools")
        self.actionQuit = QtWidgets.QAction(MainWindow)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/power-off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/pen-to-square.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/map-location-dot.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionGisTools.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/image.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImageBrowser.setIcon(icon8)
        self.actionImageBrowser.setObjectName("actionImageBrowser")
        self.actiongrass_settings = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/grass_bold_dark.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actiongrass_settings.setIcon(icon9)
