...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/epi.gif"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.menuType_Here = QtWidgets.QMenu(parent=self.menuView)
        ...
        self.toolWidget = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/tools.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.toolWidget.setWindowIcon(icon1)
        self.toolWidget.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.toolWidget.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.tools = QtWidgets.QTabWidget(parent=self.dockWidgetContents)
        ...
        self.tools.setTabPosition(QtWidgets.QTabWidget.TabPosition.North)
        self.tools.setTabShape(QtWidgets.QTabWidget.TabShape.Rounded)
        ...
        self.imageBrowsing = QtWidgets.QDockWidget(parent=MainWindow)
        self.imageBrowsing.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.groupBox_6 = QtWidgets.QGroupBox(parent=self.dockWidgetContents_2)
        ...
        self.annotation_confidence_spinBox_label = QtWidgets.QLabel(parent=self.groupBox_6)
        ...
        self.annotation_confidence_spinBox = QtWidgets.QDoubleSpinBox(parent=self.groupBox_6)
        ...
        self.rwd = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.rwd.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.rwd.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/backward.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.ImageIndexspinBox = QtWidgets.QSpinBox(parent=self.groupBox_6)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.fwd = QtWidgets.QPushButton(parent=self.groupBox_6)
        self.fwd.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.fwd.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/forward.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.ImageStepspinBox = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.zoomto = QtWidgets.QCheckBox(parent=self.groupBox_6)
        self.zoomto.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.zoomto.setText("")
        self.zoomto.setObjectName("zoomto")
        self.horizontalLayout_13.addWidget(self.zoomto)
        self.range = QtWidgets.QSpinBox(parent=self.groupBox_6)
        ...
        self.ImageIndexSlider = QtWidgets.QSlider(parent=self.groupBox_6)
        self.ImageIndexSlider.setFocusPolicy(QtCore.Qt.FocusPolicy.NoFocus)
        self.ImageIndexSlider.setProperty("value", 0)
        self.ImageIndexSlider.setSliderPosition(0)
        self.ImageIndexSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.ImageIndexSlider.setTickPosition(QtWidgets.QSlider.TickPosition.TicksBelow)
        ...
        self.link_to_image_viewer = QtWidgets.QCheckBox(parent=self.groupBox_6)
        ...
        self.gisTools_logger = QtWidgets.QLineEdit(parent=self.dockWidgetContents_2)
        ...
        self.gisTools = QtWidgets.QDockWidget(parent=MainWindow)
        ...
        self.gisTools.setFeatures(QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetFloatable|QtWidgets.QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.gisToolSplitter = QtWidgets.QSplitter(parent=self.dockWidgetContents_4)
        self.gisToolSplitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self.actionWizard = QtGui.QAction(parent=MainWindow)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/screwdriver-wrench.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/SquadraCompasso_solid.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionTools.setIcon(icon5)
        self.actionTools.setObjectName("actionTools")
        self.actionQuit = QtGui.QAction(parent=MainWindow)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/power-off.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionQuit.setIcon(icon6)
        self.actionQuit.setObjectName("actionQuit")
        self.actionAnnotation = QtGui.QAction(parent=MainWindow)
        self.actionAnnotation.setCheckable(True)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/pen-to-square.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionAnnotation.setIcon(icon7)
        self.actionAnnotation.setObjectName("actionAnnotation")
        self.actionGisTools = QtGui.QAction(parent=MainWindow)
        self.actionGisTools.setCheckable(True)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/map-location-dot.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionGisTools.setIcon(icon8)
        self.actionGisTools.setObjectName("actionGisTools")
        self.actionImageBrowser = QtGui.QAction(parent=MainWindow)
        self.actionImageBrowser.setCheckable(True)
        self.actionImageBrowser.setChecked(True)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/image.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.actionImageBrowser.setIcon(icon9)
        self.actionImageBrowser.setObjectName("actionImageBrowser")
        self.actiongrass_settings = QtGui.QAction(parent=MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/qtui/icons/grass_bold_dark.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
